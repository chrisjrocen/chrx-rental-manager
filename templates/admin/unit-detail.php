	...
	<div class="chrx-rm-detail-header">
		...
		<?php if ( $can_manage ) : ?>
			...
			<div class="chrx-rm-detail-header__actions">
				...
				<a href="<?php echo esc_url( $archive_url ); ?>" class="button" onclick="return confirm('<?php echo esc_js( __( 'Archive this unit?', 'chrx-rental-manager' ) ); ?>');"><?php esc_html_e( 'Archive', 'chrx-rental-manager' ); ?></a>
			</div>
		<?php endif; ?>
	</div>
	...
	<div style="display:grid;grid-template-columns:1.4fr 1fr;gap:18px;">
		<div>
			<div class="chrx-rm-panel">
				<div class="chrx-rm-panel__body" style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;">
					<div>
